...
def create_new_book(title: str, author_first_name: str, author_last_name: str):
    book = Book(title=title, author=Author(first_name=Name(author_first_name), last_name=Name(author_last_name)))
